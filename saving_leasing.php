            ...
            <div class="main-menu-wrap">
                ...
                <!-- align-items-center -->
                    <div class="row ">
                        ...
                        <div class="col-md-7 menu-button">
                                ...
                                <div class="menu-wraper">
                                    <nav>
                                        ...
                                        <div class="header-menu dosis">
                                            <ul>
                                                <li><a href="../PayforwardNG/">Home</a></li>
                                                <li><a href="about_us.php">About Us</a></li>
                                                <li class="active"><a href="saving_leasing.php">Saving & Leasing</a></li>
                                                <li><a href="why_payforward.php">Why Payforward</a></li>
                        ...
                        <div class="urgent-call text-right">
                               <a href="login.php" class="pr-5">SIGN IN</a>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="banner-text-inner">
                            ...
                            <h1>Stop dreaming, Start saving</h1>
                            <p><i>Grow your wealth ... payforward</i></p>
                    ...
                    <div class="col-lg-5 offset-lg-1 col-md-4 offse-xl-2">
                        ...
                        <!-- <div class="banner-image">
                            <img src="assets/img/bg_pay.jpg" alt="">
                        </div> -->
                        <!--End of banner image-->
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="section-title text-center">
                        <h2>Now You Can</h2>
                        <p>Fund your next item with a fast, affordable, personal/business loan</p>
                    </div>
                ...
                <div class="col-xl-10 col-lg-12">
                    <div class="feature-carousel owl-carousel">
                        ...
                        <div class="single-feature-inner text-center">
                            ...
                            <h5>Save<br> Money</h5>
                            <p>Start saving and grow your wealth with 10-15% per annum, no fees, no hidden charges.</p>
                        </div>
                        ...
                        <div class="single-feature-inner text-center">
                            ...
                            <h5>Instant Loan</h5>
                            <p>Easy, simple & fast funding for a range of personal/home items & SME equipments.</p>
                        </div>
                        <!-- End of single feature inner -->
                        ...
                        <div class="single-feature-inner text-center">
                            ...
                            <p>Pay with ease, while you enjoy your product</p>
                        </div>
                        <!-- End of single feature inner -->
